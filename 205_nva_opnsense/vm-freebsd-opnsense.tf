  ...
  settings             = <<SETTINGS
    {
      ...
      "commandToExecute": "sh configureopnsense.sh 'https://raw.githubusercontent.com/HoussemDellai/azure-network-course/refs/heads/main/205_nva_opnsense/scripts/' '25.7' '2.12.0.4' 'TwoNics' '10.0.1.0/24' '' '' ''"
    }
    SETTINGS
