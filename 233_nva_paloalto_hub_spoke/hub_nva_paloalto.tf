...
resource "azurerm_network_interface" "nic-vm-nva-trusted" {
  ...
  tags = { # removes SNAT requirements in NVA
    disableSnatOnPL = "true" # https://learn.microsoft.com/en-us/azure/private-link/private-link-disable-snat?tabs=vm-nic-portal%2Cvmss-portal
  }
