resource "azurerm_network_interface" "nic-vm-spoke1-windows" {
  name                = "nic-vm-spoke1-windows"
...
resource "azurerm_windows_virtual_machine" "vm-spoke1-windows" {
  name                  = "vm-spoke1-win"
  resource_group_name   = azurerm_resource_group.rg-spoke1.name
  location              = azurerm_resource_group.rg-spoke1.location
  ...
  network_interface_ids = [azurerm_network_interface.nic-vm-spoke1-windows.id]
