...
$RootCertName = "CN=P2SRootCert815"
...
Export-Certificate -Cert $RootCert -FilePath ".\P2SRootCert815Encoded.cer" -NoClobber | Out-Null

certutil -encode ".\P2SRootCert815Encoded.cer" ".\P2SRootCert815.cer" | Out-Null
...
$params = @{
    Type = 'Custom'
    Subject = 'CN=P2SClientCertt815'
    DnsName = 'P2SClientCert815'
    KeySpec = 'Signature'
    KeyExportPolicy = 'Exportable'
    KeyLength = 2048
    HashAlgorithm = 'sha256'
...
Export-PfxCertificate -FilePath ".\P2SClientCert815.pfx" -Password $CertPwd -Cert $ClientCert | Out-Null